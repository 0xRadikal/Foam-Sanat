...
export const aboutMessages = {
  fa: {
    ...
    hero: {
      ...
      secondaryCta: 'داستان کامل',
      scroll: 'اسکرول کنید'
    },
    stats: [
      { number: 15, label: 'سال تجربه', color: 'from-blue-500 to-blue-700' },
      { number: 120, label: 'پروژه موفق', color: 'from-orange-500 to-orange-700' },
      { number: 80, label: 'مشتری راضی', color: 'from-green-500 to-green-700' },
      { number: 25, label: 'متخصص', color: 'from-purple-500 to-purple-700' }
    ],
    timeline: {
  ...
  en: {
    ...
    hero: {
      ...
      secondaryCta: 'Full Story',
      scroll: 'Scroll Down'
    },
    stats: [
      { number: 15, label: 'Years Experience', color: 'from-blue-500 to-blue-700' },
      { number: 120, label: 'Successful Projects', color: 'from-orange-500 to-orange-700' },
      { number: 80, label: 'Happy Clients', color: 'from-green-500 to-green-700' },
      { number: 25, label: 'Experts', color: 'from-purple-500 to-purple-700' }
    ],
    timeline: {
      ...
      items: [
        {
          year: '2010',
          title: 'The Beginning',
          desc: 'Founded with 3 people in 100 sq.m workshop',
          highlight: 'First Step'
        },
        {
          year: '2013',
          title: 'Global Quality',
          desc: 'ISO 9001 certification and first complete line',
          highlight: 'ISO 9001'
        },
        {
          year: '2016',
          title: 'Rapid Growth',
          desc: 'Team of 15 and 50+ successful projects',
          highlight: '50 Projects'
        },
        {
          year: '2019',
          title: 'Global Markets',
          desc: 'CE Europe and exports to 5 countries',
          highlight: 'CE Europe'
        },
        {
          year: '2021',
          title: 'International Development',
          desc: '10+ countries and R&D launch',
          highlight: '10+ Countries'
        },
        {
          year: '2024',
          title: 'Regional Leadership',
          desc: '120 projects, 80 clients, 25 experts',
    ...
    mission: {
      ...
      points: [
        'World-class quality with local support',
      ...
      departments: [
        {
          ...
          count: 5,
          color: 'from-purple-500 to-purple-700',
          roles: ['CEO', 'CTO', 'Production Manager', 'Sales Director', 'CFO']
        },
        {
          name: 'Engineering',
          count: 12,
        ...
        },
        {
          ...
          count: 8,
          color: 'from-orange-500 to-orange-700',
          roles: ['Installation', 'Maintenance', 'PLC', 'Hydraulics']
        },
        {
          name: 'Support',
          count: 5,
...
export type AboutMessages = (typeof aboutMessages)[keyof typeof aboutMessages];
