...
import { hardDeleteProduct, isHardDeleteAllowed, resolvePublishedAt } from '../lib';
...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const newPublishedAt = resolvePublishedAt(existing.status, payload.status, existing.publishedAt);
